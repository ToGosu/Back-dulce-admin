...
public class ClienteDomain extends Domain {
	...
	public ClienteDomain(final UUID id, final String nombre, final String apellido, final String identificacion, final String celular, final Date fechaNacimiento, final String correo) {
		super(id);
		this.nombre=nombre;
